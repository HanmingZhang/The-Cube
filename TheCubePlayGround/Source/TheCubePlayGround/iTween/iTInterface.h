...
UINTERFACE()
class THECUBEPLAYGROUND_API UiTInterface : public UInterface
{
...
public:
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, meta = (DisplayName = "On Tween Start"), Category = "iTween|Interface Events")
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, meta = (DisplayName = "On Tween Complete"), Category = "iTween|Interface Events")

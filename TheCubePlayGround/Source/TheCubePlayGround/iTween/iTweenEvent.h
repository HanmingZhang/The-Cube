...
UCLASS()
class THECUBEPLAYGROUND_API AiTweenEvent : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	AiTweenEvent(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ECoordinateSpace::CoordinateSpace> coordinateSpace = CoordinateSpace::world;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EVectorConstraints::VectorConstraints> vectorConstraints = VectorConstraints::none;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EVector2DConstraints::Vector2DConstraints> vector2DConstraints = Vector2DConstraints::none;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ERotatorConstraints::RotatorConstraints> rotatorConstraints = RotatorConstraints::none;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EDelayType::DelayType> delayType = EDelayType::first;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ETickType::TickType> tickType = ETickType::seconds;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<EEaseType::EaseType> easeType = EEaseType::linear;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Generic Properties")
		TEnumAsByte<ELoopType::LoopType> loopType = ELoopType::once;
	...
	UFUNCTION()
		void RunInterface(UObject* target, FString type);

	//UFUNCTION()
		void RunSlateInterface(STweenableWidget* target, FString type);
	...
	UFUNCTION()
		void OrientToTargetImplementation();

	UFUNCTION()
		void OrientToPathImplementation();
